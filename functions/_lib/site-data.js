export const defaultSiteData = {
  ...
  content: {
    serviceSectionTitle: "窗帘、轨道、软装，一次上门配齐。",
    serviceSectionText: "卧室遮光、客厅纱帘、阳台轨道、全屋搭配都能做。先看样布、量尺寸，再按实际方案报价。",
    caseSectionTitle: "看真实安装效果，再决定怎么装。",
    caseSectionText: "这里展示卧室、客厅、阳台等不同空间案例，方便你参考颜色、面料、轨道和搭配方式。",
    priceSectionTitle: "先给参考价，量尺后再准报价。",
    priceSectionText: "窗帘按尺寸、面料、轨道和安装方式计价。页面先给大概范围，上门量尺后按实际方案确认。",
    stepSectionTitle: "从咨询到安装，流程简单。",
    stepSectionText: "加微信发户型和窗户照片，预约上门量尺，现场选布报价，确认后制作安装。",
    ctaTitle: "需要窗帘，先预约上门量尺。",
    ctaText: "淮滨县正义街门店，本地上门服务。可以先电话或微信咨询，确定时间后带样布上门。",
    footerNote: "一帘温馨窗帘软装生活馆，提供窗帘定制、轨道安装和全屋软装搭配服务。",
  },
};
